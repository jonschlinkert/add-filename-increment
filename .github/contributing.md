...
Don't have time to contribute? No worries, here are some other ways to show your support for increment-filename:

- star the [project](https://github.com/jonschlinkert/increment-filename)
- tweet your support for increment-filename
...
- **version**: please note the version of increment-filename are you using
